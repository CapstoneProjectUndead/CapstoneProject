...
struct InputData 
{
	...
	bool shift = false;
	bool lbtn      = false;
	bool lbtn_held = false;
	bool c         = false;

	InputData(bool _w, bool _a, bool _s, bool _d, bool _space, bool _shift, bool _lbtn = false, bool _c = false, bool _lbtn_held = false)
		: w(_w)
		, a(_a)
		, s(_s)
		, d(_d)
