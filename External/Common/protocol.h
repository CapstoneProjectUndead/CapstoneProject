...
static_assert(sizeof(S_SpawnPlayer) == 4 + 69, "S_SpawnPlayer size mismatch!");
...
static_assert(sizeof(C_Input) == 4 + 80, "C_PlayerInput size mismatch!");
...
static_assert(sizeof(S_PlayerMove) == 4 + 84, "S_PlayerMove size mismatch!");
