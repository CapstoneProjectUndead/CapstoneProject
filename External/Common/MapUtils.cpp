...
extern const int g_TreasureTableCount = (int)(sizeof(g_TreasureTable) / sizeof(g_TreasureTable[0]));
...
extern const int g_DropTableCount = (int)(sizeof(g_DropTable) / sizeof(g_DropTable[0]));
